...
C      ...        (2.) PACK EACH 6-BIT ITEM VIA SBYTESCCS;
C
C ATTRIBUTES:
C   LANGUAGE: F90
C   MACHINE:  IBM
...
C      ... ARGS FOR PACKER: SBYTESCCS()

       INTEGER    NOFFSET_S
       DATA       NOFFSET_S    / 0 /

C      ... WHERE SBYTESCCS' NOFFSET IS WITHIN PACKED DESTINATION
       INTEGER    NBITPGRP_S
       DATA       NBITPGRP_S   / 6 /

       INTEGER    NBITSKIP_S
       DATA       NBITSKIP_S   / 0 /
C      ... WHERE SBYTESCCS' NBITSKIP IS WITHIN PACKED DESTINATION
C      . . . . . . . . . . . . . . . . . . . . . . . . . . . .
C        . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
C
...
C        ... Next, to concatenate the 6-bit data-groups;
         CALL SBYTESCCS(IDESTRA,JJWORK, NOFFSET_S, NBITPGRP_S,
