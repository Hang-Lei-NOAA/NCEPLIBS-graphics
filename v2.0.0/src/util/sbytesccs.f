      SUBROUTINE SBYTESCCS(IPACKD,IUNPKD,NOFF,NBITS,ISKIP,ITER)                            
C THIS PROGRAM WRITTEN BY.....                                                  
C             DR. ROBERT C. GAMMILL, CONSULTANT                                 
C             NATIONAL CENTER FOR ATMOSPHERIC RESEARCH                          
C             JULY 1972                                                         
C THIS IS THE FORTRAN VERSIONS OF SBYTESCCS. 
C
...
C***********************************************************************
C
C SUBROUTINE SBYTESCCS (IPACKD,IUNPKD,NOFF,NBITS,ISKIP,ITER)
C
...
C
C USAGE                  CALL SBYTESCCS (IPACKD,IUNPKD,NOFF,NBITS)
C
C ARGUMENTS
C ON INPUT               IPACKD
